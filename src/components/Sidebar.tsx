...
const MENU_DATA = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { id: 'artworks', name: '박물관 작품', path: '/admin/content/artworks', icon: Palette },
      { id: 'dining', name: '레스토랑/카페', path: '/admin/content/dining', icon: UtensilsCrossed },
      ...
      { id: 'golf', name: '골프장', path: '/admin/content/golf', icon: FlagTriangleRight },
