...
interface CountryStorytellingSelectorProps {
...
export default function CountryStorytellingSelector({
  selectedLibraryId,
  onSelectLibrary,
  libraryObjects,
  selectedCountryName,
}: CountryStorytellingSelectorProps) {
            ...
            <div className="flex items-center gap-3 bg-white border border-green-200 rounded-lg p-4">
              ...
              <div>
                ...
                <h4 className="font-bold text-gray-900 text-lg">
                  {selectedObject.countryTag} 국가 개요
                </h4>
              </div>
            </div>
